...
window.webcam = {
	...
	swf_url: 'http://localhost/ebonyi/assets/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://localhost/ebonyi/assets/js/shutter.mp3', // URI to shutter.mp3 sound
