...
<main id="main-container" style="background: rgba(255, 255, 255, 0.8);">
    <div class="content bg-gray-lighter">
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading"> Session </h1>
            </div>
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>Dashboard</li>
                    <li>Setup</li>
                    <li><a class="link-effect" href="<?php echo base_url('setup/session'); ?>">Session</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="block-header">
                <h3 class="block-title">
                    ...
                    <span class="pull-right"> 
                        <a href="javascript:;" class="btn btn-default btn-sm pop" pageTitle="Add Session" pageName="<?php echo base_url('setup/session/manage'); ?>">
