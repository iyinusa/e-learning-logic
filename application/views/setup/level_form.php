<?php echo form_open_multipart('setup/level/'.$param1.'/'.$param2.'/'.$param3, array('id'=>'bb_ajax_form', 'class'=>'form-horizontal')); ?>
<div class="row">
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="form-material">
                        <input type="hidden" name="level_id" value="<?php if(!empty($e_id)){echo $e_id;} ?>" />
