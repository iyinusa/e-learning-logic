<?php echo form_open_multipart('setup/programme/'.$param1.'/'.$param2.'/'.$param3, array('id'=>'bb_ajax_form', 'class'=>'form-horizontal')); ?>
<div class="row">
    ...
    <?php if($param2 == 'delete') { // delete view ?>
        <div class="col-xs-12 text-center">
            ...
            <input type="hidden" name="d_programme_id" value="<?php if(!empty($d_id)){echo $d_id;} ?>" />
        </div>
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="form-material">
                        <input type="hidden" name="programme_id" value="<?php if(!empty($e_id)){echo $e_id;} ?>" />
