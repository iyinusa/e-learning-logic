...
<body>
	<div style="width:95%; background-color:#eee; margin:auto; padding:10px;">
        <div style="background-color:#fff; border:1px solid #999; margin:auto;">
            <div class="e_header">
                <a href="<?php base_url(); ?>"><img alt="<?php echo app_name; ?> " src="<?php echo base_url(); ?>assets/img/favicons/apple-touch-icon-57x57.png" /></a>
            </div>
            ...
            <div class="e_footer">
                <strong><?php echo app_name; ?> Team</strong>
            </div>
        </div>
    </div>
</body>
